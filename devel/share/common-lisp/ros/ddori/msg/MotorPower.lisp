...
(cl:defmethod cl:initialize-instance :after ((m <MotorPower>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotorPower)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ddori-msg:<MotorPower> is deprecated: use ddori-msg:MotorPower instead.")))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <MotorPower>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ddori-msg:state-val is deprecated.  Use ddori-msg:state instead.")
  (state m))
