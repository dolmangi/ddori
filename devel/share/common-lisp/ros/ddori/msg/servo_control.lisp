...
(cl:defmethod cl:initialize-instance :after ((m <servo_control>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'servo_control)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ddori-msg:<servo_control> is deprecated: use ddori-msg:servo_control instead.")))

(cl:ensure-generic-function 'no-val :lambda-list '(m))
(cl:defmethod no-val ((m <servo_control>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ddori-msg:no-val is deprecated.  Use ddori-msg:no instead.")
  (no m))

(cl:ensure-generic-function 'pos-val :lambda-list '(m))
(cl:defmethod pos-val ((m <servo_control>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ddori-msg:pos-val is deprecated.  Use ddori-msg:pos instead.")
  (pos m))
