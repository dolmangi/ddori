...
(cl:defmethod cl:initialize-instance :after ((m <MotorPower>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'MotorPower)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ddori_msgs-msg:<MotorPower> is deprecated: use ddori_msgs-msg:MotorPower instead.")))

(cl:ensure-generic-function 'state-val :lambda-list '(m))
(cl:defmethod state-val ((m <MotorPower>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ddori_msgs-msg:state-val is deprecated.  Use ddori_msgs-msg:state instead.")
  (state m))
