...
(cl:defmethod cl:initialize-instance :after ((m <motor_speed>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'motor_speed)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name ddori_msgs-msg:<motor_speed> is deprecated: use ddori_msgs-msg:motor_speed instead.")))

(cl:ensure-generic-function 'left_speed-val :lambda-list '(m))
(cl:defmethod left_speed-val ((m <motor_speed>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ddori_msgs-msg:left_speed-val is deprecated.  Use ddori_msgs-msg:left_speed instead.")
  (left_speed m))

(cl:ensure-generic-function 'right_speed-val :lambda-list '(m))
(cl:defmethod right_speed-val ((m <motor_speed>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader ddori_msgs-msg:right_speed-val is deprecated.  Use ddori_msgs-msg:right_speed instead.")
  (right_speed m))
