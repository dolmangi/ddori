// Generated by gencpp from file ddori_msgs/ddori_sensor.msg
// DO NOT EDIT!


#ifndef DDORI_MSGS_MESSAGE_DDORI_SENSOR_H
#define DDORI_MSGS_MESSAGE_DDORI_SENSOR_H
...
struct ddori_sensor_
{
  ...
  typedef boost::shared_ptr< ::ddori_msgs::ddori_sensor_<ContainerAllocator> > Ptr;
  typedef boost::shared_ptr< ::ddori_msgs::ddori_sensor_<ContainerAllocator> const> ConstPtr;

}; // struct ddori_sensor_

typedef ::ddori_msgs::ddori_sensor_<std::allocator<void> > ddori_sensor;

typedef boost::shared_ptr< ::ddori_msgs::ddori_sensor > ddori_sensorPtr;
typedef boost::shared_ptr< ::ddori_msgs::ddori_sensor const> ddori_sensorConstPtr;
...
std::ostream& operator<<(std::ostream& s, const ::ddori_msgs::ddori_sensor_<ContainerAllocator> & v)
{
ros::message_operations::Printer< ::ddori_msgs::ddori_sensor_<ContainerAllocator> >::stream(s, "", v);
return s;
}
...
template <class ContainerAllocator>
struct IsFixedSize< ::ddori_msgs::ddori_sensor_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsFixedSize< ::ddori_msgs::ddori_sensor_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ddori_msgs::ddori_sensor_<ContainerAllocator> >
  : TrueType
  { };

template <class ContainerAllocator>
struct IsMessage< ::ddori_msgs::ddori_sensor_<ContainerAllocator> const>
  : TrueType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ddori_msgs::ddori_sensor_<ContainerAllocator> >
  : FalseType
  { };

template <class ContainerAllocator>
struct HasHeader< ::ddori_msgs::ddori_sensor_<ContainerAllocator> const>
  : FalseType
  { };


template<class ContainerAllocator>
struct MD5Sum< ::ddori_msgs::ddori_sensor_<ContainerAllocator> >
{
  ...
  static const char* value(const ::ddori_msgs::ddori_sensor_<ContainerAllocator>&) { return value(); }
  static const uint64_t static_value1 = 0x3676e7aa50bcd8c8ULL;
  static const uint64_t static_value2 = 0x9f9c5ae2f526915bULL;
};

template<class ContainerAllocator>
struct DataType< ::ddori_msgs::ddori_sensor_<ContainerAllocator> >
{
  static const char* value()
  {
    return "ddori_msgs/ddori_sensor";
  }
...
template<class ContainerAllocator>
struct Definition< ::ddori_msgs::ddori_sensor_<ContainerAllocator> >
{
  static const char* value()
  {
    return "\n\
...
namespace serialization
{
  ...
  template<class ContainerAllocator> struct Serializer< ::ddori_msgs::ddori_sensor_<ContainerAllocator> >
  {
...
template<class ContainerAllocator>
struct Printer< ::ddori_msgs::ddori_sensor_<ContainerAllocator> >
{
  template<typename Stream> static void stream(Stream& s, const std::string& indent, const ::ddori_msgs::ddori_sensor_<ContainerAllocator>& v)
  {
    s << indent << "time_stamp: ";
...
#endif // DDORI_MSGS_MESSAGE_DDORI_SENSOR_H
